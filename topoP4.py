...
class MyTopo(Topo):
    ...
    def __init__(self):
        ...
        # add spine switches
        self.spineswitch.append(self.addSwitch("spine1", cls=ONOSBmv2Switch, pipeconf=PIPECONF_ID))
        self.spineswitch.append(self.addSwitch("spine2", cls=ONOSBmv2Switch, pipeconf=PIPECONF_ID))

        # add leaf switches
        self.leafswitch.append(self.addSwitch("leaf1", cls=ONOSBmv2Switch, pipeconf=PIPECONF_ID))
        self.leafswitch.append(self.addSwitch("leaf2", cls=ONOSBmv2Switch, pipeconf=PIPECONF_ID))
...
if __name__ == "__main__":
    ...
    net.addController('c0', controller=RemoteController, ip=controllerIp)
